...
public class AtualizarPaciente extends javax.swing.JFrame {
    ...
    public AtualizarPaciente(Paciente paciente) {
        ...
        txtID.setText(String.valueOf(this.pc.getIdPaciente()));
        txtNome.setText(this.pc.getNome());
        txtCpf.setText(this.pc.getCpf());
        ...
        txtNascimento.setText(this.pc.getData_nasc().replaceAll("-", "/"));
        
        txtEndereco.setText(this.pc.getEndereco());
        txtTelefone.setText(this.pc.getTelefone());
    ...
    private boolean emptyFields(){
        ...
        if(txtID.getText().trim().isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "ATENÇÃO! O ID não pode estar vazio.");
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        ...
                        .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtEndereco, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
    ...
    private void AtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AtualizarActionPerformed
        if(emptyFields() == false){
            ...
            paciente.setData_nasc(txtNascimento.getText().replaceAll("/", "-"));
            
            paciente.setEndereco(txtEndereco.getText().toUpperCase()); 
            paciente.setTelefone(txtTelefone.getText());
            

            resposta = dao.atualizar(paciente, Integer.valueOf(txtID.getText()));
            if(resposta == 1){
