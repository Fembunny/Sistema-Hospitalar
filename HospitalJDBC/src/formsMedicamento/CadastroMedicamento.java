...
public class CadastroMedicamento extends javax.swing.JFrame {
    ...
    private void CadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CadastrarActionPerformed
        if(emptyFields() == false){
            ...
            medicamento.setQuantidade(Integer.valueOf(txtQuantidade.getText()));
            medicamento.setValor(Double.valueOf(txtValor.getText()));
            
            resposta = medicamentoDAO.Salvar(medicamento);
            if(resposta == 1){
                ...
                JOptionPane.showMessageDialog(null,"Medicamento já foi cadastrado");   
            }
            else{
